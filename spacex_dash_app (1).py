...
def create_scatter(site, payload):
    ...
    if site == 'ALL':
        ...
        print(filter_df[['class','Payload Mass (kg)']])
        fig=px.scatter(filter_df,x='Payload Mass (kg)', y='class',title='Correlation between Payload mass and success for all Sites',color="Booster Version Category")
    return fig
